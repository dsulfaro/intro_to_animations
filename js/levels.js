...
export const EDITOR = ["@keyframes color_change{<br>  from { background-color: red; } <br>  to { <input type='text' id='main-input'> }<br>}",
...
export const SOLUTIONS = ["background-color:purple;",
"background-color:yellow;",
""]

export const DIVS = ["<div id='level-1-div'></div>",
